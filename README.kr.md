...
```bash
codex plugin marketplace add https://github.com/phi-friday/codex-orchestrator --ref main
```

GitHub shorthand를 사용할 수도 있습니다.

```bash
codex plugin marketplace add phi-friday/codex-orchestrator --ref main
```
